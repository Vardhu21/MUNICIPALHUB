...
function Portal() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-background">
      ...
      <div
        key={`atmos-${zoomKey}`}
        className="animate-atmos-fade pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_40%,#3A3A3A18,transparent_60%),radial-gradient(circle_at_50%_90%,#3A3A3A10,transparent_55%)]"
      />
